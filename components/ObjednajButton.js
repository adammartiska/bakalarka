...
const ObjednajButton = props => {
    ...
    return (
            <View style={[styles.customButon, props.styles]}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center', marginHorizontal: 2, marginVertical: 3}}>
...
const styles = StyleSheet.create({
    ...
    alignItems: 'center', width: 220, margin: 0, height: 50,  backgroundColor: Colors.primaryColor, borderWidth: 1, borderColor: Colors.sedatmava
        , borderRadius: 4, elevation: 12,
